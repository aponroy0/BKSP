...
export default function Form() {
  ...
  return (
    <main className="bg-[#F9F7F7] min-h-screen">
      ...
      <div className="w-full max-w-3xl mx-auto px-3 sm:px-6 pb-16">
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-5 overflow-hidden">
            ...
            <div className="p-4 sm:p-8">
              {/* ─────────────────────────────────────────────────────
                  LAYOUT STRATEGY:
                  The entire form body is split into two columns on desktop:
                    • LEFT  col (flex-1) : all form fields stacked vertically
                    • RIGHT col (w-32)   : photo box pinned at the top

                  On mobile: single column, photo centred above all fields
              ───────────────────────────────────────────────────── */}
              ...
              <div className="flex gap-6 items-start">
                ...
                <div className="flex-1 space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select className={inputBase} {...register("bloodGroup")}>
                ...
                {/* RIGHT — photo box, desktop only, pinned at top */}
              ...
              {/* END desktop two-column wrapper */}
            </div>
          </div>
